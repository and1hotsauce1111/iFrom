                    ...
                    <div class="question_type" v-for="(question,index) in page.questionDataPerPage.pageQuestionData">
                        ...
                        <div class="question_title_radio" v-if="question.type === 'radio'" :id="'q-'+ question.questionNum">
                            ...
                            <div class="question_content_radio" v-for="option in question.options">
                                <label class="label_radio">
                                    <input type="radio" :value="option.val" v-model="question.isSelect" @change="singleInputVal(option.id,index,question.questionNum, question.type)"/>
                        ...
                        <div class="question_title_pulldown" v-if="question.type === 'pulldown'" :id="'q-'+ question.questionNum">
                            ...
                            <div class="question_content_pulldown">
                                <v-dropdown :id="question.id" :setting="dropSetting" :data="dropData[question.id]" v-model="question.isSelect" @onend="singleInputVal(question.isSelect,index,question.questionNum,question.type)"><v-dropdown>
                            </div>
                        </div>
                        ...
                        <div class="question_title_textarea" v-if="question.type === 'textarea'" :id="'q-'+ question.questionNum">
                            ...
                            <div class="question_content_textarea">
                                <div style="font-size: 0">
                                    <textarea rows="3" placeholder="輸入內容..." v-model="question.answerVal" @change="singleInputVal(question.isSelect,index,question.questionNum, question.type)"></textarea>
                                </div>
                            </div>
                        </div>
